...
void plot_2D ( TString filename = "speed_iter_short", TString title ="", TString xlabel ="Learning Speed", TString ylabel ="Number of Iterations", bool xlog=0, bool ylog=0 )
{
